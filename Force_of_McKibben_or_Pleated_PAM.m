%% Force of McKibben and Pleated PAM
%%
...
%Set D_E, the diameter of end of PAM (m)
D_E=0.016;
...
l_1=L_1./2;
l_2=L_2./2;
%Calculate volume of deflated PAM (cylinder)
V_1= pi*(D_E/2)^2*L_1;
%Calculate diameter of inflated PAM at widest point
D_2=D_E+(2*sqrt(l_1.^2 - l_2.^2));
...
ylabel('Force (N)')
title('Force Exerted by McKibben or Pleated PAM as it Contracts')
